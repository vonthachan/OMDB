...
public class API {
	...
	/**
	 * Wrapper for parsing a string into base characters
	 * 
	 * @param input_string
	 * @return
	 * @throws SQLException
	...
	public static String[] getBaseChars(String input_string) throws SQLException, UnsupportedEncodingException {
		String URL = "https://indic-wp.thisisjava.com/api/getBaseCharacters.php?string="
				+ URLEncoder.encode(input_string, "UTF-8") + "&language='" + LANGUAGE + "'";
		String newURL = URL.replaceAll(" ", "%20");
		Client client = Client.create();
		WebResource resource = client.resource(newURL);
		...
		for(int i = 0; i < temp_array.length; i++) { 
			temp_array[i] = temp_array[i].toLowerCase();
		}
